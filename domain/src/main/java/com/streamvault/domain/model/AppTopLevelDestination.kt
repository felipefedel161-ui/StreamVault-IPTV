...
enum class AppTopLevelDestination(
    ...
    NOVELAS("novelas", AppLandingDestination.NOVELAS),
    INFANTIL("infantil", AppLandingDestination.INFANTIL),
    ANIMES("animes", AppLandingDestination.ANIMES),
    FOOTBALL("football", AppLandingDestination.FOOTBALL),
