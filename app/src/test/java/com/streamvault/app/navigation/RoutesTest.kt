...
class RoutesTest {
    ...
    fun `app landing destinations map to routes`() {
        ...
        assertThat(AppLandingDestination.NOVELAS.toAppRoute()).isEqualTo(Routes.NOVELAS)
        assertThat(AppLandingDestination.INFANTIL.toAppRoute()).isEqualTo(Routes.INFANTIL)
        assertThat(AppLandingDestination.ANIMES.toAppRoute()).isEqualTo(Routes.ANIMES)
    ...
    fun `top level destinations map to routes including search`() {
        ...
        assertThat(AppTopLevelDestination.NOVELAS.toAppRoute()).isEqualTo(Routes.NOVELAS)
        assertThat(AppTopLevelDestination.INFANTIL.toAppRoute()).isEqualTo(Routes.INFANTIL)
        assertThat(AppTopLevelDestination.ANIMES.toAppRoute()).isEqualTo(Routes.ANIMES)
